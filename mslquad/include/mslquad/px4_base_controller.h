...
class PX4BaseController
{
  ...
  protected:
    ...
    sensor_msgs::Joy joyCmds_;                         // Joystick Commands
  ...
  private:
    ...
    ros::Subscriber joySub_;        // Joystick subscriber
    ...
    void joySubCB(const sensor_msgs::Joy::ConstPtr &msg); // Joystick Callback
};
