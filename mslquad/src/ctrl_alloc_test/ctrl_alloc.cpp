...
ctrl_alloc::ctrl_alloc(int quad_count, float arm_length)
{
  ...
  std::cout << quad[0].motor_pos[0][0] << " " << quad[0].motor_pos[1][0] << " "
            << quad[0].motor_pos[2][0] << " " << quad[0].motor_pos[3][0] << std::endl;

  std::cout << quad[0].motor_pos[0][1] << " " << quad[0].motor_pos[1][1] << " "
            << quad[0].motor_pos[2][1] << " " << quad[0].motor_pos[3][1] << std::endl;

  std::cout << quad[1].motor_pos[0][0] << " " << quad[1].motor_pos[1][0] << " "
            << quad[1].motor_pos[2][0] << " " << quad[1].motor_pos[3][0] << std::endl;

  std::cout << quad[1].motor_pos[0][1] << " " << quad[1].motor_pos[1][1] << " "
            << quad[1].motor_pos[2][1] << " " << quad[1].motor_pos[3][1] << std::endl;
